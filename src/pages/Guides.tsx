  ...
  return (
    <div className="min-h-screen bg-[#1a1410] text-white">
      ...
      <div className="border-b border-white/10 bg-black/20">
        <div className="max-w-[1200px] mx-auto px-8 py-16">
          <div className="flex items-center gap-4 mb-4">
            <BookOpen className="h-12 w-12 text-[#d4823b]" />
            <h1
          ...
          <p className="text-xl text-white/70 max-w-3xl">
            Sobrevivencia, personagens, bosses e estacoes. Esta pagina vai centralizar os
            guias mais importantes do jogo.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-8 py-12">
        <div className="bg-black/40 border border-white/10 rounded-lg p-12 text-white/70">
